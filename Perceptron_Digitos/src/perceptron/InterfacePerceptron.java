...
import perceptron.Aprendizagem;
import perceptron.Validacao;
...
public class InterfacePerceptron extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new Thread(() -> {
        apr = new Aprendizagem(DadosDigitos.entradas, DadosDigitos.saidasDesejadas);
        apr.treinar(
            Double.parseDouble(jTextField1.getText()), // alfa
            Double.parseDouble(jTextField2.getText()), // limiar
            1000 // ou qualquer valor de máx. épocas
        );
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
      val = new Validacao();
    jTextField4.setText(
        val.teste(mat, apr.getPesos(), Double.parseDouble(jTextField2.getText()))
    );
